...
string(FIND "${_cudaArch}" "5.2" arch_52)
string(FIND "${_cudaArch}" "6.1" arch_61) #test arnaud
...
elseif((NOT ${arch_52} LESS 0)) #test arnaud

    set(cuda_arch_version 52 ) #test arnaud
        set(cuda_arch_version_string 5.2 ) #test arnaud
    set(cuda_generation Maxwell) #test arnaud

elseif((NOT ${arch_61} LESS 0)) #test arnaud

    set(cuda_arch_version 61 ) #test arnaud
        set(cuda_arch_version_string 6.1 ) #test arnaud
    set(cuda_generation Pascal ) #test arnaud
