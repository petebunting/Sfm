...
# So where does pymicmac really help? It helps reduce the time Tapioca takes 
# seemingly

# However, malt & pims are already parallelised, so a local process it is no use here
# It would be useful to subdivide the data, so for tiling this is a merit of the matching part, though it only uses Malt 
